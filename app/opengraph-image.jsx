...
export default function Image() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "#101728", color: "#f8f9ff", padding: "58px 66px", fontFamily: "sans-serif" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}><div style={{ display: "flex", flexDirection: "column", fontSize: 80, fontWeight: 700, letterSpacing: -4, lineHeight: 1.08 }}><span>Zachowaj najlepszy</span><span style={{ display: "flex" }}>moment<span style={{ color: "#9d95fa" }}>.</span></span></div><div style={{ fontSize: 26, color: "#b9c4de" }}>Wycinaj fragmenty filmów z YouTube. Zapisuj MP4 na Windows i macOS.</div></div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "2px solid #33415e", paddingTop: 24, color: "#9d95fa", fontSize: 18, fontWeight: 700 }}><span>DARMOWA APLIKACJA NA WINDOWS I MACOS</span><span>WERSJA 1.1.6</span></div>
    </div>,
    size
  );
}
